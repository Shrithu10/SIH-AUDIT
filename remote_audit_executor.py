...
def read_file(win_version: str) -> dict:
    ...
    #     'Windows 11 Pro': 'src\Audit\CIS_MS_Windows_11_Enterprise_Level_1_v1.0.0.xlsx',
    ...
    # }
    version_dict = {
        'Windows 11 Pro': r'C:\Users\Administrator 1\Downloads\CIS-Auditor-Windows-master\src\Audit\CIS_Microsoft_Windows_11_Stand-alone_v3.0.0_L1 (2).xlsx'
